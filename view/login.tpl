<!DOCTYPE html>
    ...
    <body class="login-content">
        ...
        <form class="form-login  form-horizontal form-horizontal-simple" action="{$route->generate('LoginPage')}" enctype="application/x-www-form-urlencoded" method="post">
        ...
        <form class="form-login  form-horizontal form-horizontal-simple" action="{$route->generate('LostPasswordPage')}" enctype="application/x-www-form-urlencoded" method="post">
